...
// enforced in code (script.js), so a markdown edit can change the teaching but cannot
...
export async function listLessonTypes() {
...
export function chooseLessonType(plan, episodeNumber) {
...
export async function buildLessonPrompt(lessonType, newWords, reviewWords) {
