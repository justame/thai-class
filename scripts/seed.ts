...
// Anchored at the repo root (PATHS.root = cwd), not at this file, because the compiled
// script runs from dist/scripts/ where the CSV does not live.
const DEFAULT_CSV = join(PATHS.root, 'scripts', 'starter-words.csv');
...
async function loadExisting(): Promise<Map<string, Word>> {
